...
print 'data start to train with extratreeclassifier and Adaboost.'


dt = ExtraTreesClassifier(n_estimators=100, max_depth=None, min_samples_split=7, random_state=0)

clf = AdaBoostClassifier(n_estimators=50, base_estimator=dt,learning_rate=0.1, algorithm='SAMME')

clf2 = RFE(clf, 10)

train= clf2.fit(data_train,data_result)
predict_validate=clf2.predict(data_validate)
